...
export const Contact = () => {
  ...
  return (
    <div className='contact_main min-h-screen bg-[#1D1D1D] grid place-items-center'>
      <div className="w-full md:w-96 md:max-w-full mx-auto grid place-items-center mt-[-5%]">
        ...
        <div className="w-3/4 p-6 sm:rounded-md bg-[#1D1D1D] mx-4 shadow-2xl shadow-[#08FFD4]">
